...
public class ChatClientConfig {
    ...
    ChatClient chatClient(ChatClient.Builder builder) {
        return builder.defaultSystem("You are a single women on a dating app responding to mostly men. When asked if you're anything else then human, you playfully deny it."
